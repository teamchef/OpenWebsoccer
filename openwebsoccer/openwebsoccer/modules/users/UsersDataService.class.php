...
class UsersDataService
{
	...
	*/
	public static function createLocalUser($websoccer, $db, $nick = null, $email = null)
	{
		$username = trim($nick);
	...
	* @throws Exception
	*/
	public static function countActiveUsersWithHighscore($websoccer, $db)
	{
	...
	* @throws Exception
	*/
	public static function getActiveUsersWithHighscore($websoccer, $db, $startIndex, $entries_per_page)
	{
		$columns['U.id'] = 'id';
		$columns['nick'] = 'nick';
		$columns['email'] = 'email';
	...
	* @throws Exception
	*/
	public static function getUserById($websoccer, $db, $userId)
	{
		$columns['id'] = 'id';
		$columns['nick'] = 'nick';
		$columns['email'] = 'email';
	...
	* @throws Exception
	*/
	public static function getUserIdByNick($websoccer, $db, $nick)
	{
		$columns = 'id';
		$fromTable = $websoccer->getConfig('db_prefix') . '_user';
	...
	* @throws Exception
	*/
	public static function getUserIdByEmail($websoccer, $db, $email)
	{
		$columns = 'id';
		$fromTable = $websoccer->getConfig('db_prefix') . '_user';
	...
	* @throws Exception
	*/
	public static function findUsernames($websoccer, $db, $nickStart)
	{
		$columns = 'nick';
		$fromTable = $websoccer->getConfig('db_prefix') . '_user';
	...
	* @return NULL|string either URL to profile picture or NULL if none is configured.
	* @throws Exception
	*/
	public static function getUserProfilePicture($websoccer, $fileName, $email, $size = 40)
	{
		if (strlen($fileName)) {
	...
	* @throws Exception
	*/
	public static function getGravatarUserProfilePicture($websoccer, $email, $size = 40)
	{
		// use gravatar
	...
	* @throws Exception
	*/
	public static function countOnlineUsers($websoccer, $db)
	{
	...
	* @throws Exception
	*/
	public static function getOnlineUsers($websoccer, $db, $startIndex, $entries_per_page)
	{
	...
	* @throws Exception
	*/
	public static function countTotalUsers($websoccer, $db)
	{
