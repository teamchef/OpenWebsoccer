...
class NationalteamsDataService
{
	 ...
	 */
	public static function findPlayersCount(WebSoccer $websoccer, DbConnection $db, $nationality, $teamId, $firstName, $lastName, $position, $mainPosition)
	{
	 ...
	 * @throws Exception
	 */
	private static function executeFindQuery(WebSoccer $websoccer, DbConnection $db, $columns, $limit, $nationality, $teamId, $firstName, $lastName, $position, $mainPosition)
	{
