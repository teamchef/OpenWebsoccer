...
if (!$show) {
	...
	<form action='<?php echo $_SERVER['PHP_SELF']; ?>' method='post'>
		...
		<input type='hidden' name='site' value='<?php echo $site; ?>'><p>
		<input type='submit' class='btn' value='<?php echo $i18n->getMessage('all_logging_button_empty_file'); ?>'></p>
	</form><p>(
	<?php
	echo $i18n->getMessage('all_logging_only_last_entries_shown'); ?>)</p>
