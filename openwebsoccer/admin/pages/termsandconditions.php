...
// die als XML-Datei gespeicherten Daten nach der angegebnen Sprache einlesen
$selectedLang = (isset($_POST["lang"])) ? $_POST["lang"] : $i18n->getCurrentLanguage();
$termsFile = ROOT . "/admin/config/termsandconditions.xml";
