	...
	*/
	public function execute()
	{
		...
		SELECT team_id,
			...
			(home_wins * $pointsWin + home_draws) AS home_points, home_goals, home_goalsreceived,
			(home_goals - home_goalsreceived) AS home_goalsdiff, home_wins, home_draws, home_losses,
			(guest_wins * $pointsWin + guest_draws) AS guest_points, guest_goals, guest_goalsreceived,
			(guest_goals - guest_goalsreceived) AS guest_goalsdiff, guest_wins, guest_draws, guest_losses
