...
*/
class SeasonOfTeamCompletedEvent extends BaseModel
{
	/**
	...
	* @internal param SimulationPlayer $player player data model.
	*/
	public function __construct($websoccer, $db, $i18n, $teamId, $seasonId, $rank)
	{
