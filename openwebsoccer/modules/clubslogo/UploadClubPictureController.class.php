...
define("CLUBPICTURE_UPLOAD_DIR", ROOT . "/uploads/club");
class UploadClubPictureController extends BaseModel
{
	...
	FUNCTION executeAction($parameters)
	{
		...
		// check file size (just for Sekurity issues. Usually, PHP will not accept too big files)
