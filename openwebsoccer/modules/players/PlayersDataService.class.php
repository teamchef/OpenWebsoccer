...
class PlayersDataService
{
	 ...
	 * @return array list of found players or empty array.
	 */
	public static function findPlayers(WebSoccer $websoccer, DbConnection $db, $firstName, $lastName, $clubName, $position, $strengthMax, $lendableOnly, $startIndex, $entries_per_page)
	{
		$columns['P.id'] = 'id';
		$columns['P.vorname'] = 'firstname';
		$columns['P.nachname'] = 'lastname';
	 ...
	 */
	public static function findPlayersCount(WebSoccer $websoccer, DbConnection $db, $firstName, $lastName, $clubName, $position, $strengthMax, $lendableOnly)
	{
		$columns = 'COUNT(*) AS hits';
	...
	/**
	* Provides players ranked by assists in the current season.
	* by Schabbell
	* @param WebSoccer $websoccer Application context.
	* @param DbConnection $db DB connection.
	* @param int $limit Maximum number of players to fetch.
