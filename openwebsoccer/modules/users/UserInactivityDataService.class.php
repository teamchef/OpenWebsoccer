...
{
	FUNCTION getUserInactivity($websoccer,$db,$userId)
	{
		$columns['id'] = 'id';
		$columns['login'] = 'login';
	...
	FUNCTION computeUserInactivity($websoccer,$db,$userId)
	{
	...
	FUNCTION resetContractExtensionField($websoccer,$db,$userId)
	{
		$inactivity = self::getUserInactivity($websoccer,$db,$userId);
	...
	FUNCTION increaseContractExtensionField($websoccer,$db,$userId)
	{
		$inactivity = self::getUserInactivity($websoccer,$db,$userId);
