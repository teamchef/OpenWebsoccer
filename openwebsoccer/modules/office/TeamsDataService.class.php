...
class TeamsDataService
{
	...
	/*
	 * @author Weiss Florian
	 * Methode um die Kadergröße eines Vereins festzustellen
	 * @param teamID - ID des Teams
	 * @return size - Zeigt die Anzahl der aktiven Spieler eines Teams an
	 * @return market_value - Zeigt den gesamten MW aller Spieler eines Teams an
	*/
	public static function countPlayersOfTeamById($websoccer, $db, $teamId)
	{
	...
	/*
	 * @author Weiss Florian
	 * Methode um die Ausländerquote eines Vereins festzustellen
	 * @param teamID - ID des Teams
	 * @return size - Zeigt die Anzahl der aktiven ausländischen Spieler eines Teams an
	*/
	public static function countOutOfLeagueNationPlayersOfTeamById($websoccer, $db, $teamId, $country)
	{
	 ...
	 * @return int number of players playing for specified team.
	 */
	public static function getTeamSizeContract($websoccer, $db, $clubId)
	{
		$columns = 'COUNT(*) AS number';
		$fromTable = $websoccer->getConfig('db_prefix') .'_spieler';
