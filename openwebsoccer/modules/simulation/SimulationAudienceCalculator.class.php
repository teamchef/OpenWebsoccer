...
{
	FUNCTION computeAndSaveAudience(WebSoccer $websoccer,DbConnection $db,SimulationMatch $match)
	{
	...
	FUNCTION getHomeInfo($websoccer,$db,$teamId)
	{
	...
	FUNCTION computeRate($avgPrice,$avgSales,$actualPrice,$fanpopularity,$isAttractiveMatch,$maintenanceInfluence)
	{
	...
	FUNCTION updateMaintenanceStatus(WebSoccer $websoccer,DbConnection $db,$homeInfo)
	{
		$columns = array(
	...
	FUNCTION weakenPlayersDueToGrassQuality(WebSoccer $websoccer,$homeInfo,SimulationMatch $match)
	{
