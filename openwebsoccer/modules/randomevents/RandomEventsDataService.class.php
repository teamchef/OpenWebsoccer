...
{
	FUNCTION createEventIfRequired($websoccer, $db, $userId)
	{
		// is feature enabled?
	...
	FUNCTION _createAndExecuteEvent($websoccer, $db, $userId, $clubId)
	{
	...
	FUNCTION _executeEvent($websoccer, $db, $userId, $clubId, $event)
	{
