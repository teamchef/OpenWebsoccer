...
class PremiumDataService
{
	...
	* @throws Exception
	*/
	public static function countAccountStatementsOfUser($websoccer, $db, $userId)
	{
	...
	* @throws Exception
	*/
	public static function getAccountStatementsOfUser($websoccer, $db, $userId, $startIndex, $entries_per_page)
	{
	...
	*/
	public static function creditAmount($websoccer, $db, $userId, $amount, $subject, $data = null)
	{
		if ($amount === 0) {
			return;
		}
	...
	*/
	public static function debitAmount($websoccer, $db, $userId, $amount, $subject, $data = null)
	{
		if ($amount === 0) {
			return;
		}
	...
	*/
	public static function createPaymentAndCreditPremium($websoccer, $db, $userId, $amount, $subject)
	{
		if ($amount <= 0) {
	...
	* @throws Exception
	*/
	public static function getPaymentsOfUser($websoccer, $db, $userId, $limit)
	{
