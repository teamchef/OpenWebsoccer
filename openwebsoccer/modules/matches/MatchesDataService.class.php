...
class MatchesDataService
{
	...
	* @return array
	*/
	public static function getNextMatches($websoccer, $db, $clubId, $maxNumber)
	{
	...
	* @throws Exception
	*/
	public static function getNextMatch($websoccer, $db, $clubId)
	{
		$fromTable = self::_getFromPart($websoccer);
	...
	* @throws Exception
	*/
	public static function getsecondNextMatch($websoccer, $db, $clubId)
	{
		$fromTable = self::_getFromPart($websoccer);
		$formationTable = $websoccer->getConfig('db_prefix') . '_aufstellung';
		$fromTable .= ' LEFT JOIN ' . $formationTable . ' AS HOME_F ON HOME_F.verein_id = HOME.id AND HOME_F.match_id = M.id';
	 ...
	 * @throws Exception
     */
	public static function getthirdNextMatch(WebSoccer $websoccer, DbConnection $db, $clubId) {
		$fromTable = self::_getFromPart($websoccer);
		$formationTable = $websoccer->getConfig('db_prefix') . '_aufstellung';
		$fromTable .= ' LEFT JOIN ' . $formationTable . ' AS HOME_F ON HOME_F.verein_id = HOME.id AND HOME_F.match_id = M.id';
		$fromTable .= ' LEFT JOIN ' . $formationTable . ' AS GUEST_F ON GUEST_F.verein_id = GUEST.id AND GUEST_F.match_id = M.id';
	 ...
	 * @throws Exception
     */
	public static function getfourthNextMatch(WebSoccer $websoccer, DbConnection $db, $clubId) {
		$fromTable = self::_getFromPart($websoccer);
		$formationTable = $websoccer->getConfig('db_prefix') . '_aufstellung';
		$fromTable .= ' LEFT JOIN ' . $formationTable . ' AS HOME_F ON HOME_F.verein_id = HOME.id AND HOME_F.match_id = M.id';
		$fromTable .= ' LEFT JOIN ' . $formationTable . ' AS GUEST_F ON GUEST_F.verein_id = GUEST.id AND GUEST_F.match_id = M.id';
	...
	* @return array
	*/
	public static function getLiveMatch($websoccer, $db)
	{
		$fromTable = self::_getFromPart($websoccer);
	...
	* @param DbConnection $db
	* @param $matchId
	* @param bool|TRUE $loadStadiumInfo
	* @param bool|FALSE $loadSeasonInfo
	* @return array
	* @throws Exception
	*/
	public static function getMatchById($websoccer, $db, $matchId, $loadStadiumInfo = TRUE, $loadSeasonInfo = FALSE)
	{
		$fromTable = self::_getFromPart($websoccer);
		if ($loadStadiumInfo) {
	...
	* @throws Exception
	*/
	public static function getMatchSubstitutionsById($websoccer, $db, $matchId)
	{
	...
	* @return array
	*/
	public static function getLastMatch($websoccer, $db)
	{
	...
	* @return array
	*/
	public static function getLiveMatchByTeam($websoccer, $db, $teamId)
	{
	...
	* @return array
	*/
	private static function _getMatchSummaryByCondition($websoccer, $db, $whereCondition, $parameters)
	{
		$fromTable = self::_getFromPart($websoccer);
		$columns['M.id'] = 'match_id';
		$columns['M.datum'] = 'match_date';
	...
	* @return array
	*/
	public static function getPreviousMatches($matchinfo, $websoccer, $db)
	{
		$fromTable = self::_getFromPart($websoccer);
	...
	* @throws Exception
	*/
	public static function getCupRoundsByCupname($websoccer, $db)
	{
		$columns['C.name'] = 'cup';
	...
	* @return array
	*/
	public static function getMatchesByMatchday($websoccer, $db, $seasonId, $matchDay)
	{
	...
	* @return array
	*/
	public static function getMatchesByCupRound($websoccer, $db, $cupName, $cupRound)
	{
	...
	* @return array
	*/
	public static function getMatchesByCupRoundAndGroup($websoccer, $db, $cupName, $cupRound, $cupGroup)
	{
	...
	* @param DbConnection $db
	* @param int $limit
	* @param bool|FALSE $ignoreFriendlies
	* @return array
	*/
	public static function getLatestMatches($websoccer, $db, $limit = 20, $ignoreFriendlies = FALSE)
	{
	...
	* @return array
	*/
	public static function getLatestMatchesByUser($websoccer, $db, $userId)
	{
	...
	* @return array
	*/
	public static function getLatestMatchesByTeam($websoccer, $db, $teamId)
	{
	...
	* @return array
	*/
	public static function getTodaysMatches($websoccer, $db, $startIndex, $entries_per_page)
	{
	...
	* @throws Exception
	*/
	public static function countTodaysMatches($websoccer, $db)
	{
		$startTs = mktime(0, 0, 1, date('n'), date('j'), date('Y'));
		$endTs = $startTs + 3600 * 24;
	...
	* @return array
	*/
	public static function getMatchesByTeamAndTimeframe($websoccer, $db, $teamId, $dateStart, $dateEnd)
	{
	...
	* @throws Exception
	*/
	public static function getMatchdayNumberOfTeam($websoccer, $db, $teamId)
	{
	...
	* @throws Exception
	*/
	public static function getMatchReportPlayerRecords($websoccer, $db, $matchId, $teamId)
	{
	...
	* @throws Exception
	*/
	public static function getMatchPlayerRecordsByField($websoccer, $db, $matchId, $teamId)
	{
		$fromTable = $websoccer->getConfig('db_prefix') . '_spiel_berechnung AS M';
		$fromTable .= ' INNER JOIN ' . $websoccer->getConfig('db_prefix') . '_spieler AS P ON P.id = M.spieler_id';
		$columns = [
	...
	* @throws Exception
	*/
	public static function getMatchReportMessages($websoccer, $db, $i18n, $matchId)
	{
	...
	*/
	public static function getMatchesByCondition($websoccer, $db, $whereCondition, $parameters, $limit)
	{
		$fromTable = self::_getFromPart($websoccer);
		$columns['M.id'] = 'id';
