...
******************************************************************/
SEC;
class TransferOffersSentModel extends BaseModel {
	FUNCTION renderView() {
	...
	FUNCTION getTemplateParameters() {
		...
		if ($count > 0) {
			$offers = DirectTransfersDataService::getSentOffers($this->_websoccer,$this->_db,
					$paginator->getFirstIndex(),$eps,$clubId,$userId);
		} else {
			$offers = array();
		}
