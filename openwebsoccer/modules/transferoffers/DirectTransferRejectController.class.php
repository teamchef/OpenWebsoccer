...
class DirectTransferRejectController extends BaseModel
{
	...
	public function executeAction($parameters)
	{
		...
		$result = $this->_db->querySelect('*', $this->_websoccer->getConfig('db_prefix') . '_transfer_offer', 'id = %d AND receiver_club_id = %d', [$parameters['id'], $clubId]);
		...
		['playername' => $playerName, 'receivername' => $this->_websoccer->getUser()->username], 'transferoffer', 'transferoffers#sent');
