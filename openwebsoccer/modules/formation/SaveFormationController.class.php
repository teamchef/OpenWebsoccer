...
*/
class SaveFormationController extends BaseModel
{
	/**
	* SaveFormationController constructor.
	* @param I18n $i18n
	...
	*/
	private function saveFormation($teamId, $matchId, $parameters, $validSubstitutions)
	{
		...
		// update or insert?
		$result = $this->_db->querySelect('id', $fromTable, 'verein_id = %d AND match_id = %d', [$teamId, $matchId]);
