...
{
	public static function getCamps($websoccer, $db)
	{
	...
	public static function getCampBookingsByTeam($websoccer, $db, $teamId)
	{
	...
	public static function getCampById($websoccer, $db, $campId)
	{
		$fromTable = $websoccer->getConfig('db_prefix') . '_trainingslager';
		$whereCondition = 'id = %d';
	...
	public static function executeCamp($websoccer, $db, $teamId, $bookingInfo)
	{
