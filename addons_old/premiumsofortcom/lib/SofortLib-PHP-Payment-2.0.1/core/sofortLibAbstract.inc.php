...
abstract class SofortLibAbstract
{
     ...
     * @internal param $ (optional) array $message response array
     */
     ...
     * @param string $notifyOn Comma seperated (notification on: loss|pending|received|refunded|untraceable)
     * @return SofortLibAbstract $this
     * @internal param string $notification
     */
     ...
     * @param string $field
     * @internal param $ (optional) string $field - if $errorCode deals with a field
     */
